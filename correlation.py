...
ax1 = plt.subplot(411)
plt.scatter(pearson_correlation[:]['label'], pearson_correlation[:]['r'], color='blue', marker='x')
ax1.grid(color='lightgray', linestyle='-', linewidth='0.5')
ax1.set_title('r value of Pearson correlation coefficient')
plt.tight_layout()
ax2 = plt.subplot(412)
plt.scatter(pearson_correlation[:]['label'], pearson_correlation[:]['p_value'], color='red', marker='x')
